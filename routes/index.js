...
router.post('/wikiSearch', DvdsController.wikiSearch);
router.post('/wikiData', DvdsController.wikiData);
...
router.delete('/api/episode/:dvdId/:episodeId', DvdsController.api.deleteEpisode);
